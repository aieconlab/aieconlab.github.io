...
CHECKS = [
    ...
    # 2026-07-28 재확인: 두 문서가 같은 값($3.48)을 적고 있다(5차의 '$4.40 상충' 서술 폐기 근거)
    ("together_serverless_models.html",
     [("V4-Pro 행 $1.74/$0.20/$3.48",
       r"DeepSeek-V4-Pro.{0,300}?\$1\.74.{0,120}?\$0\.20.{0,120}?\$3\.48")]),
    ("together_v4pro_quickstart.html", ["3.48"]),
...
calc = [
    ...
    ("Together 서빙가는 딥시크 자사의 4.0배", abs(3.48 / 0.87 - 4.0) < 1e-9),
